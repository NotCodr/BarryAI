    ...
    <motion.div
      ...
      transition={{ duration: 0.3 }}>
        ...
        transition={{ delay: 0.3, duration: 0.4 }}>
                ...
                <p className="text-white/70 text-sm leading-relaxed max-w-[260px]">Your University of Melbourne student smart assistant. I'm here to help you navigate student life

            ...
            <div className="absolute inset-0 flex items-center">
                <div className="max-w-7xl mx-auto px-4 sm:px-8 w-full">
                    <div className="max-w-lg">
                        <h1 className="text-3xl sm:text-[42px] md:text-[50px] font-bold text-white leading-[1.1] mb-4 font-serif">Welcome to the BarryAI Project

            </h1>
                        <p className="text-white/90 text-base sm:text-lg mb-6 leading-relaxed">Imagine our institution had this on our website!

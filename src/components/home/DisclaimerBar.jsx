  ...
  return (
    <div className="bg-[#e6a817] text-[#0c1f42] relative z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex items-center gap-3">
                ...
                <p className="text-sm font-semibold flex-1">This is not the official University of Melbourne website. This is a student-led project by Team BarryAI and is not affiliated with, endorsed by, or connected to The University of Melbourne.
